...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Frondesk Blog | AI Dealership Insights & Automotive Growth Strategies",
    description:
  ...
  twitter: {
    ...
    title:
      "Frondesk Blog | AI Dealership Insights & Automotive Tech Trends",
    description:
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                {/* ---- AUTHOR BLOCK + SVG ICONS (UNCHANGED) ---- */}
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg">
                    AI-integrated vehicle inspection system…
                  </p>
...
//                  AI-integrated vehicle inspection system providing automatic dent and damage detection plus detailed reports to empower customer decision-making
//                   </p>
//                   <div className="mb-10 w-full overflow-hidden rounded-sm">
//                     <div className="relative aspect-97/60 w-full sm:aspect-97/44">
//                       <Image
